...
public class CustomResize {
	...
	public static void main(String[] args) {
		SpringApplication.run(CustomResize.class, args);
		System.out.println();
		defineDirectory();
	...
	public static void defineDirectory() {
		...
		String inputDirPath = "C:\\Users\\aatif\\OneDrive\\business\\design\\non HD\\temp";
		String outputDirPath ="C:\\Users\\aatif\\OneDrive\\business\\design\\non HD\\temp";
	...
	private static void upscaleImage(String imageFileName, int width, int height, String filePath,
